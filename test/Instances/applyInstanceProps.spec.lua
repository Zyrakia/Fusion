...
return function()
    it("should assign properties (constant)", function()
        ...
        applyInstanceProps({Name = "Bob"}, semiWeakRef(instance))
    ...
    it("should assign properties (state)", function()
        ...
        local instance = Instance.new("Folder")
        applyInstanceProps({Name = value}, semiWeakRef(instance))
        expect(instance.Name).to.equal("Bob")
    ...
    it("should assign Parent (constant)", function()
        ...
        local instance = Instance.new("Folder")
        applyInstanceProps({Parent = parent}, semiWeakRef(instance))
    ...
    it("should assign Parent (state)", function()
        ...
        local instance = Instance.new("Folder")
        applyInstanceProps({Parent = value}, semiWeakRef(instance))
    ...
    it("should throw for non-existent properties (constant)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({NotARealProperty = true}, semiWeakRef(instance))
    ...
    it("should throw for non-existent properties (state)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({NotARealProperty = Value(true)},
    ...
    it("should throw for invalid property types (constant)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({Name = Vector3.new()}, semiWeakRef(instance))
    ...
    it("should throw for invalid property types (state)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({Name = Value(Vector3.new())},
                               semiWeakRef(instance))
        end).to.throw("invalidPropertyType")
    end)
    ...
    it("should throw for invalid Parent types (constant)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({Parent = Vector3.new()}, semiWeakRef(instance))
        end).to.throw("invalidPropertyType")
    end)
    ...
    it("should throw for invalid Parent types (state)", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({Parent = Value(Vector3.new())},
                               semiWeakRef(instance))
        end).to.throw("invalidPropertyType")
    end)
    ...
    it("should throw for unrecognised keys in the property table", function()
        expect(function()
            local instance = Instance.new("Folder")
            applyInstanceProps({[2] = true}, semiWeakRef(instance))
    ...
    it("should not inhibit garbage collection", function()
        ...
        do
            local instance = Instance.new("Folder")
            applyInstanceProps({Name = Value("Bob")}, semiWeakRef(instance))

            ref[1] = instance
        end

        local startTime = os.clock()
        repeat task.wait() until ref[1] == nil or os.clock() > startTime + 15
