...
return function()
    ...
    it("should assign multiple children to instances", function()
        local ins = New "Folder" {
            ...
            [Children] = {
                New "Folder" {Name = "Fred"}, New "Folder" {Name = "George"},
                New "Folder" {Name = "Harry"}
            }
        }
    ...
    it("should flatten children to be assigned", function()
        local ins = New "Folder" {
            ...
            [Children] = {
                New "Folder" {Name = "Fred"},
                {
                    New "Folder" {Name = "George"},
                    {New "Folder" {Name = "Harry"}}
                }
            }
        }
    ...
    it("should bind State objects passed as children", function()
        ...
        local parent = New "Folder" {[Children] = {children}}
    ...
    it("should recursively bind State children", function()
        ...
        local children = Value({
            child1, Value(child2), Value({child3, Value(Value(child4))})
        })
    ...
    it("should not inhibit garbage collection", function()
        ...
        do
            ref[1] = New "Folder" {
                [Children] = {
                    Instance.new("Folder"), Value(Instance.new("Folder"))
                }
            }
        end

        local startTime = os.clock()
        repeat task.wait() until ref[1] == nil or os.clock() > startTime + 10
