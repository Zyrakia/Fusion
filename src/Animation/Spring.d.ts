...
export declare interface Spring<T> {
	...
	/**
	 * Sets the position of the interal springs, meaning the value of this
	...
	/**
	 * Sets the velocity of the interal springs, an overwriting the existing velocity
	...
	/**
	 * Adds to the velocity of the interal springs, on top of the existing
